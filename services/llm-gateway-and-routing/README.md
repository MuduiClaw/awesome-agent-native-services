...
| [XiuRouter](xiurouter.md) | One API for leading models. Selected routes save 90%+ | OpenAI Responses/Chat, Anthropic Messages, Gemini GenerateContent, scoped keys | ⚠️ |
