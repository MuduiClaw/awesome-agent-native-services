...
| **Stars** | [![GitHub Stars](https://img.shields.io/github/stars/BrowserMCP/mcp?style=social)](https://github.com/BrowserMCP/mcp) |
...
Browser MCP provides browser MCP server for AI agents. Its agent-facing value is to give autonomous systems a programmatic primitive that can be invoked during a task loop without requiring a human to operate a dashboard for each action.
...
| Criterion | Evidence |
|---|---|
| **Agent-first positioning** | Upstream tagline/README explicitly targets AI agents: "Browser MCP server for AI agents." |
| **Agent-specific primitives** | Puppeteer MCP, accessibility-tree actions, optional vision. |
...
| **M2M integration surface** | Puppeteer MCP, accessibility-tree actions, optional vision. |
...
|---|---|
| **Agent runtime surface** | Puppeteer MCP, accessibility-tree actions, optional vision |
...
```
Operator provisions Browser MCP
  ↓
...
| Interface | Detail |
|---|---|
| **Primary surface** | Puppeteer MCP, accessibility-tree actions, optional vision |
...
- Autonomous coding, research, support, or operations agents that need browser MCP server for AI agents
