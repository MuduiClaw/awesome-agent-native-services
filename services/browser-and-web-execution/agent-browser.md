...
| **Stars** | [![GitHub Stars](https://img.shields.io/github/stars/vercel-labs/agent-browser?style=social)](https://github.com/vercel-labs/agent-browser) |
...
Vercel Agent Browser provides browser automation CLI for AI agents. Its agent-facing value is to give autonomous systems a programmatic primitive that can be invoked during a task loop without requiring a human to operate a dashboard for each action.
...
| Criterion | Evidence |
|---|---|
| **Agent-first positioning** | Upstream tagline/README explicitly targets AI agents: "Browser automation CLI for AI agents." |
| **Agent-specific primitives** | Rust CLI, Chrome for Testing, scriptable browser control. |
...
| **M2M integration surface** | Rust CLI, Chrome for Testing, scriptable browser control. |
...
|---|---|
| **Agent runtime surface** | Rust CLI, Chrome for Testing, scriptable browser control |
...
```
Operator provisions Vercel Agent Browser
  ↓
...
| Interface | Detail |
|---|---|
| **Primary surface** | Rust CLI, Chrome for Testing, scriptable browser control |
...
- Autonomous coding, research, support, or operations agents that need browser automation CLI for AI agents
