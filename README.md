...
| [XiuRouter](services/llm-gateway-and-routing/xiurouter.md) | One API for leading models. Selected routes save 90%+ | Protocol-aware setup · Scoped API key · Request usage records · Four native routes | ⚠️ | Create a scoped key, then follow [Agent integrations](https://router.xiu.ai/en/integrations) for the client's native protocol |
