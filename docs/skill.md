...
| [XiuRouter](https://router.xiu.ai/en) | One API for leading models. Selected routes save 90%+ | Create a scoped key, then follow [Agent integrations](https://router.xiu.ai/en/integrations) for the client's native protocol |
